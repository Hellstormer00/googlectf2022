...
// limitations under the License.
	...
	#define l MA(l0, l1, l2, l3, l4, l5, l6, l7)
		...
		#endif
	#endif
	// NOTE: In this S gets defined to 6 which implicitly means failure
	// !!!: The cascading R1-R7 check MUST succeed!!!
	#if S == 5
		#undef S
		#define S 6
		#ifndef R0
		...
		#endif
	#endif
	// NOTE: In this S gets defined to 7 which implicitly means failure
	#if S == 6
		#undef S
		#define S 7
		#undef c
		...
		#endif
	#endif
	// NOTE: In this S gets defined to 8 or 59 which implicitly means failure
	#if S == 7
		#undef S
		#define S 8
		#ifndef R0
		...
		#endif
	#endif
	// NOTE: In this S gets defined to 9 which implicitly means failure
	#if S == 8
		#undef S
		#define S 9
		#undef c
		...
		#endif
	#endif
	// NOTE: Here S gets defined to 59 or 10. This means failure in each case!!!
	// The Programm isn't allowed to enter S == 9
	#if S == 9
		#undef S
		#define S 10
		#ifndef R0
	...
	// NOTE: How to end up here?
		...
		#define S 12
		#undef S
		// NOTE: S is defined to -1. Interesting
		#define S -1
	#endif
	#if S == 12
		#undef S
		...
		#undef Y7
	#endif
	// NOTE: Here 22 gets defined multiple times
	#if S == 14
		#undef S
		#define S 15
		#ifndef X0
		...
		#define S 1
	#endif
	// NOTE: Here starts interesting part
	#if S == 24
		#undef S
		#define S 25
		#undef I0
		...
		#endif
	#endif
	// NOTE: Here begins loading of ROM
	#if S == 34
		#undef S
		#define S 35
		// NOTE: A = LD(ROM_B)
