...
#undef S
#define S 1
#pragma message "#define S 1"
#undef S
#define S 24
#pragma message "#define S 24"
#endif
#if S == 1
#pragma message "S==1"
#warning "S==1"
